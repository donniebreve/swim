...
namespace UnitTests.Helpers
{
    ...
    public class WorkItemTrackingHelperTests
    {
        ...
        {
            var query = WorkItemTrackingHelper.ParseQueryForPaging("SELECT * FROM WorkItems order BY System.Id", null);
        ...
        {
            var parsedQuery = WorkItemTrackingHelper.ParseQueryForPaging("SELECT * FROM WorkItems", null);
        ...
        {
            var query = WorkItemTrackingHelper.GetPageableQuery("SELECT * FROM WorkItems WHERE System.Id = 1", 1, 1);
        ...
        {
            var query = WorkItemTrackingHelper.GetPageableQuery("SELECT * FROM WorkItems", 1, 1);
        ...
        {
            var query = WorkItemTrackingHelper.ParseQueryForPaging("SELECT * FROM WorkItems order BY System.Id", "Migrated");
        ...
        {
            var query = WorkItemTrackingHelper.ParseQueryForPaging("SELECT * FROM WorkItems WHERE System.Id = 1 order BY System.Id", "Migrated");
